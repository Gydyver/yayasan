...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('payment', function (Blueprint $table) {
            $table->id();
            // $table->integer('billing_id');//untuk catatan, pindah ketabel payment_detail
            // $table->foreign('billing_id')->references('id')->on('billing');
            $table->timestamps('transfer_time')->nullable();
            ...
            $table->string('notes_admin')->nullable(); // untuk di update
