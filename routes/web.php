...
//     Route::post('/login_perform', 'login')->name('login.perform');
//     // Route::post('/login_perform2', 'login')->name('login.perform2');
// });

Route::controller(LoginManualController::class)->group(function () {
    Route::get('/login', 'show')->name('login.view');
    Route::post('/login_perform', 'login')->name('login.perform');
    Route::get('/notAllowed', 'notAllowed')->name('notAllowed');
    // Route::post('/login_perform2', 'login')->name('login.perform2');
});

// Route::get('/input_encrypt', 'EncryptionController@index');
// Route::post('/encrypt_id', 'EncryptionController@encryptID')->name('encrypt_id');
...
Route::controller(EncryptionController::class)->group(function () {
    Route::get('/input_encrypt', 'index')->name('index');
    Route::post('/encrypt_id', 'encryptID')->name('encrypt_id');
});
Route::controller(PythonController::class)->group(function () {
    Route::get('/testingPthyon', 'executePythonScript')->name('testingphyton');
});
